...
+ (void)getGeofencesForUser:(NSString *)userId atLocation:(CLLocation *)location success:(void (^)(NSArray *))success
{
	...
	QLGeoFenceCircle *geofence = [[QLGeoFenceCircle alloc] init];
	geofence.longitude = 37.776074;
	geofence.latitude = -122.394304;
	geofence.radius = 50;
	geofencePlace.geoFence = geofence;
	
	[geofenceArray addObject:geofencePlace];
	
	success(geofenceArray);
}
